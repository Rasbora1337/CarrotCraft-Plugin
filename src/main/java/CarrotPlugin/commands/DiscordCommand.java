    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (sender instanceof Player) {
            ...
            player.sendMessage(TextComponent.ofChildren(carrotcraft,
                    Component.text("Click here to join our Discord!", TextColor.fromHexString("#FFFF55"), TextDecoration.BOLD)
                            .clickEvent(ClickEvent.clickEvent(ClickEvent.Action.OPEN_URL,
                                    "https://discord.gg/pqrXapRyym")).hoverEvent(Component.text("Click here to join our Discord!"))));
        }
